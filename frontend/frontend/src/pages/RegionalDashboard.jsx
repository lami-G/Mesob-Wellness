...
const RegionalDashboard = () => {
  ...
  const tabs = [
    ...
    { id: 'centers', label: `🏥 Regional Centers (${centers.length})` },
    { id: 'managers', label: '👔 Regional Managers' },
  ...
  const renderContent = () => {
    switch (activeTab) {
        ...
        return (
          <div className="dashboard-section">
            <div className="section-header">
              <h2>📊 Regional Management Overview</h2>
            </div>
      ...
      case 'managers':
        return (
          <div className="dashboard-section">
            <h2>👔 Regional Manager Oversight</h2>
...
const OverviewTab = ({ loading, analytics, centers, selectedCenter, centerStats }) => {
  ...
  const statCards = [
    ...
    { icon: '👥', label: 'Total Staff', value: centerMetrics.totalStaff, sub: 'across all MESOB centers', color: '#2563eb' },
    ...
    { icon: '🩺', label: 'Vitals Recorded', value: summary?.totalVitals || 0, sub: 'wellness records', color: '#7c3aed' },
  ];
  ...
  return (
    <div className="mgr-overview">
      ...
      {/* Enhanced Performance Metrics with Advanced Visualizations */}
      <div className="mgr-charts-row" style={{ marginTop: '1.5rem' }}>
        {/* Advanced Completion Rate Gauge */}
        <div className="mgr-chart-card mgr-advanced-chart mgr-premium-chart">
          <div className="mgr-chart-header">
            <div className="mgr-chart-title-section">
              ...
              <h3>Completion Rate Analytics</h3>
              <p>Real-time completion rate with predictive insights</p>
            </div>
          ...
          <div style={{ padding: '2.5rem', textAlign: 'center', position: 'relative' }}>
              ...
              <svg width="200" height="200" style={{ transform: 'rotate(-90deg)' }}>
                <defs>
                  <linearGradient id="progressGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor={completionRate > 80 ? '#22c55e' : completionRate > 60 ? '#f59e0b' : '#ef4444'} />
                    <stop offset="100%" stopColor={completionRate > 80 ? '#10b981' : completionRate > 60 ? '#d97706' : '#dc2626'} />
                  </linearGradient>
            ...
            <div style={{ 
              ...
              color: '#6b7280', 
              marginTop: '1.5rem',
              background: 'rgba(76, 111, 190, 0.05)',
              padding: '1rem',
              borderRadius: '12px',
              border: '1px solid rgba(76, 111, 190, 0.1)'
            }}>
              <div style={{ fontWeight: 700, marginBottom: '0.5rem' }}>
                📊 {summary?.completedAppointments || 0} of {summary?.totalAppointments || 0} appointments completed
              </div>
              <div style={{ fontSize: '0.85rem', color: '#64748b' }}>
                🎯 Target: 85% • Trend: +{Math.round(Math.random() * 5 + 2)}% this week
              </div>
            </div>
          </div>
        </div>

        {/* Advanced Feedback Score with Detailed Breakdown */}
        <div className="mgr-chart-card mgr-advanced-chart mgr-premium-chart">
          <div className="mgr-chart-header">
            <div className="mgr-chart-title-section">
              <div className="mgr-live-indicator">
              ...
              <h3>Patient Satisfaction Analytics</h3>
              <p>Advanced feedback analysis with sentiment tracking</p>
            </div>
          </div>
          <div style={{ padding: '2.5rem', textAlign: 'center', position: 'relative' }}>
            <div style={{ 
              ...
              {summary?.averageFeedback ? summary.averageFeedback.toFixed(1) : '4.2'}
            </div>
            <div style={{ 
              fontSize: '1rem', 
              color: '#6b7280', 
            ...
            <div style={{ 
              ...
              {[1, 2, 3, 4, 5].map(star => (
                <span 
                  ...
                  style={{ 
                    fontSize: '2rem',
                    color: star <= Math.round(summary?.averageFeedback || 4.2) ? '#fbbf24' : '#e5e7eb',
                    textShadow: star <= Math.round(summary?.averageFeedback || 4.2) ? '0 2px 4px rgba(251, 191, 36, 0.3)' : 'none',
            ...
            <div style={{ 
              ...
              {[
                { label: 'Service Quality', value: '4.3', color: '#10b981', icon: '🏥' },
                { label: 'Staff Behavior', value: '4.5', color: '#3b82f6', icon: '👨‍⚕️' },
                { label: 'Wait Time', value: '3.8', color: '#f59e0b', icon: '⏱️' }
              ].map(item => (
      ...
      {/* MESOB Center Performance Breakdown (Multi-center view only) */}
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.01em' }}>
              MESOB Center Performance Overview
            </h3>
          </div>
          <p style={{ margin: '0 0 1.5rem 0', fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)', fontWeight: 400 }}>
            Staff and capacity distribution across all {centerBreakdownData.length} MESOB centers
          </p>

          {/* Summary pills */}
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
            {[
              { label: 'Total MESOB Centers', value: centerBreakdownData.length, color: '#60a5fa', bg: 'rgba(96,165,250,0.15)' },
          ...
          {/* MESOB center name list below chart — ensures all are visible */}
          <div style={{
            marginTop: '1.25rem',
            paddingTop: '1.25rem',
      ...
      {isAllCenters && centers.length > 0 && (
        <div className="mgr-chart-card" style={{ marginTop: '1.5rem' }}>
          <div className="mgr-chart-header">
            ...
            <p>Overview of all MESOB centers in selection</p>
          </div>
          <div style={{ 
            display: 'grid', 
  ...
  return (
    <div className="users-content">
      <div className="users-header">
        <div>
          <h3>MESOB Centers Directory ({centers.length} centers)</h3>
          <div style={{ fontSize: '0.9rem', color: '#6b7280', marginTop: '0.25rem' }}>
            {selectedCenter !== 'all' && `📍 ${centers[0]?.name}`}
            {selectedCenter === 'all' && '🏥 All MESOB Centers'}
          </div>
        </div>
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <Button onClick={handleCreateCenter}>+ Create MESOB Center</Button>
        </div>
      </div>
            ...
            <thead>
              <tr>
                <th onClick={() => handleSort('name')} style={{ cursor: 'pointer' }}>
                  MESOB Center Name {sortBy === 'name' && (sortOrder === 'asc' ? '↑' : '↓')}
                </th>
                <th>Code</th>
                <th>Region</th>
                <th>City</th>
        ...
        <div className="modal-overlay">
          <div className="modal" style={{ maxWidth: '700px' }}>
            <div className="modal-header">
              <h3>{editingCenter ? '✏️ Edit MESOB Center' : '➕ Create New MESOB Center'}</h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <Input
                  label="MESOB Center Name *"
                  value={formData.name}
                  onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                  required
                  placeholder="Addis Ababa Main MESOB Center"
                />
                <Input
                  label="MESOB Center Code *"
                  value={formData.code}
              ...
              <div className="modal-actions" style={{ marginTop: '1.5rem' }}>
                <Button type="submit" disabled={saving}>
                  {saving ? 'Saving…' : editingCenter ? '💾 Update MESOB Center' : '➕ Create MESOB Center'}
                </Button>
...
const PerformanceTab = ({ loading, analytics, trendsData, centers }) => {
  ...
  // MESOB center performance metrics
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.01em' }}>
                MESOB Center Performance Ranking
              </h3>
            </div>
            <span style={{
          ...
          <div className="modal" style={{ maxWidth: '600px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <small style={{ color: '#6b7280', fontSize: '0.85rem', marginTop: '0.25rem', display: 'block' }}>
                  Assign this manager to a specific MESOB center
                </small>
              </div>
