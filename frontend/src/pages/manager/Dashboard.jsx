...
const ManagerDashboard = () => {
  ...
  // Use TanStack Query hook for all data fetching
  const {
    capacityInfo,
    bookingStats,
    queueData,
      ...
      case 'overview':
        return (
          <div className="dashboard-section">
            ...
            <OverviewTab loading={isLoading} capacityInfo={capacityInfo} bookingStats={bookingStats} healthData={healthData} />
          </div>
        );
      case 'analytics':
        return (
          <div className="dashboard-section">
            ...
            <AnalyticsTab loading={isLoading} queueData={queueData} healthData={healthData} trendsData={trendsData} />
          </div>
        );
      case 'users':
        return (
          <div className="dashboard-section">
            ...
            <UsersTab loading={isLoading} users={users} onRefresh={refetch} />
          </div>
        );
      case 'audit':
        return (
          <div className="dashboard-section">
            ...
            <AuditTab loading={isLoading} logs={auditLogs} />
          </div>
        );
      case 'settings':
        return (
