...
import { useFederalDashboard, useCreateRegion } from "../../hooks/useFederalData";
...
function FederalDashboard() {
  ...
  const { regions, centers, allCenters, analytics, trends, isLoading, error, refetch } = 
    useFederalDashboard(selectedRegion);
