...
import styles from './WellnessPlanTemplates.module.css';
...
function WellnessPlanTemplates({ onSelectTemplate, onClose }) {
  ...
  return (
    <div className={styles.wellnessTemplatesModal}>
      <div className={styles.modalOverlay} onClick={onClose}></div>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h3>Wellness Plan Templates</h3>
          <button className={styles.btnClose} onClick={onClose} type="button">✕</button>
        </div>

        <div className={styles.modalBody}>
          <p className={styles.modalInstruction}>Click on a template to select it, then click Apply</p>
