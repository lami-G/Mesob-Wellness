...
import styles from './CallNextControl.module.css';
...
function CallNextControl({ onNavigateToVitals, onStatusChanged }) {
  ...
  return (
    <div className={`card ${styles.callNextControl}`}>
      ...
      <div className={styles.currentCustomerDisplay}>
        {currentCustomer ? (
          <>
            <div className={styles.displayScreen}>
              <div className={styles.displayContent}>
                <p className={styles.displayLabel}>Now Serving:</p>
                <p className={styles.displayName}>{currentCustomer.customerName}</p>
                <p className={styles.displayId}>ID: {currentCustomer.appointmentId?.substring(0, 12)}...</p>
