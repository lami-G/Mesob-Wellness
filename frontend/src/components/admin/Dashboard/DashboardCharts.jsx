...
function DashboardCharts() {
  ...
  if (loading) return <div className={styles.dashboardCharts}><p>Loading charts...</p></div>;
  if (!metrics) return <div className={styles.dashboardCharts}><p>No data available</p></div>;
